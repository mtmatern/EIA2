...
function handleRequest(_request: Http.IncomingMessage, _response: Http.ServerResponse): void {
    ...
    let query: AssocStringString = < AssocStringString> Url.parse(_request.url, true).query; /*Parsen die URL in einen Assoziativen string string. Also aus URL ein Array: mit command ist der key und insert. name key, scheuerle... */
